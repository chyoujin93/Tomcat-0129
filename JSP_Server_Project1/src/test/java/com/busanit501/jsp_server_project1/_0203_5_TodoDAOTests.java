...
public class _0203_5_TodoDAOTests {
    ...
    // 2) 테스트를 할 때, 항상 todoDAO 객체가 필요해서
    // 각 메서드가 실행되기 전에 미리 생성하는 코드
    @BeforeEach
    public void ready(){
        // 각각의 단위테스트 메서드가 실행되기 전에 생성자 호출, 객체를 인스턴스화 한다.
    ...
    public void testInsert() throws Exception {
        // 화면에서 전달받은 데이터를 임시로 더미데이터로 전달.
        // 객체 생성시 기존에 A a = new A() 대신에
        // _0203_1_TodoVO vo2 = new _0203_1_TodoVO();
        // vo2.setTitle("샘플제목")
        // vo2.setDueDate(LocalDate.now())
        // 지금 생성이 안되는 이유는, setter 정의를 안했고, 생성자도 정의를 안해서 그러함.

        // builder 패턴 이용해보기
        // 사용할때, _0203_1_TodoVO 클래스에 어노테이션으로 @Builder 필요함
    ...
    // 하나 조회
    @Test
    public void testSelctOne() throws Exception {
        // 조회할 tno를 알고있음
        Long tno = 4L;
        // 조회
    ...
    public void testDeleteOne() throws Exception {
        // 삭제할 번호를 알고있다. 각자 디비에 있는 tno 번호를 이용하기
        // 예시 tno = 4L
        Long tno = 4L;
